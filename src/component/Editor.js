    ...
    const getProblemsById = () => {
        ...
        axios.get(`https://prepavenger-backend.herokuapp.com/${problemtype}/${id}`).then(
            (success) => {
                ...
                setinputdata(success.data.input);
                setactualoutput(success.data.output);
